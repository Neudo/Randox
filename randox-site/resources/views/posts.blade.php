<x-app-layout>
    ...
    @if(session('success'))
        <div class="max-w-7xl py-6 mx-auto sm:px-6 lg:px-8">
            <p class="bg-green-400"> {{ session('success') }}</p>
        </div>
    @endif
    <div class="">
                            ...
                            <div class="wrapper-top">
                                <li class="flex justify-between items-center">
                                    ...
                                    <div class="action flex">
                                        ...
                                        <a href="{{ route('posts.edit', $post->slug) }}" class="btn text-white ml-3 p-2 hover:bg-yellow-700 bg-yellow-600" title="Modifier l'article" >Modifier</a>
                                    </div>
                                </li>
                            </div>
                        </ul>
