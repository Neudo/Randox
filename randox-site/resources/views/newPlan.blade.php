<x-app-layout>
    ...
    <div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-black">
                    <form class="flex-col" action="{{ route('plan.new') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="group mb-6 flex flex-col">
                            ...
                            <span class="italic">150 caractères max.</span>
                            <input id="info" name="info" class="rounded" type="text" value="{{ old('info') }}">
                        </div>
                        <div class="group mb-6 flex flex-col">
                            ...
                            <input id="stripe_id" name="stripe_id" class="rounded" type="text" value="{{ old('stripe_id') }}">
                        </div>
                        ...
                        <div class="group flex mb-6 flex-col">
                            ...
                            <input id="price" class="rounded" name="price" type="number" step="0.01" value="{{ old('price') }}" />
                        </div>
